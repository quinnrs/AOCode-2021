...
cards = get_data(my_data) # get the cards and assign bcid
print(len(cards)) 
...
"""   part 1  - correct answer is  44736     """
for number in ping_pong_balls:
    for card in cards:
        ...
        if win:
            ...
            print(winner_score(card, number))
            score = winner_score(card, number)
            break
...
print('Part 1:', score1) # expect 4512 ball 24
print('Part 2:', score2) # expect 1924 ball 13