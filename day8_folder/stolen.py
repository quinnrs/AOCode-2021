...
lines = file.read().splitlines() # single line here
...
for line in lines:
    two_parts = line.split(" | ") #single line ['signals' , 'digits]
    # print(two_parts)  #debug
...
print(f"\nPart 1 = %d"%count )
# returned   for example data CORRECT
# returned 344  data CORRECT
